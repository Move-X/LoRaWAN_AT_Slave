...
static LmHandlerErrorStatus_t LmhpDataDistributionInit(void);
static LmHandlerErrorStatus_t LmhpPackagesRegister(uint8_t id, LmhPackage_t **package);
...
//#warning "removed print from keys"
	#ifndef PRINT_RELEASE
...
void LmHandlerProcess( void )
{
    ...
    // New
    if(Send_test == true && is_rx2_elapsed == true && mac_send == false && ACK_value == 0)
    {
                                      ...
                                      TimerTime_t *nextTxIn, bool allowDelayedTx )
{
    ...
    else
    {
        ...
        else
        {
            ...
            mcpsReq.Req.Confirmed.NbTrials = 2; //8; MODIFIED
        }
    }
